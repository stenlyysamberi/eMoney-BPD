...
public class AdapterInfoTerbaru extends RecyclerView.Adapter<AdapterInfoTerbaru.ViewHolder> {

    Context context;
    String data1[], data2[];
    String [] images;

    public AdapterInfoTerbaru(Context context, String[] data1, String[] data2, String[] images) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.row_info_terbaru,parent,false);
